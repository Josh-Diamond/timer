    ...
    render() {
        return (
            <div>
                ...
                <div>
                    <button onClick={this.start} style={{ margin: '0 3%', height: '30px', width: '75px', fontSize: '1.25rem', letterSpacing: '1.8px', borderRadius: '5px', border: 'none', backgroundColor: '#28A745', color: 'white', outline: 'none', cursor: 'pointer'}}>Start</button>
                    <button onClick={this.stop} style={{ margin: '0 3%', height: '30px', width: '75px', fontSize: '1.25rem', letterSpacing: '1.8px', borderRadius: '5px', border: 'none', backgroundColor: '#DC3545', color: 'white', outline: 'none', cursor: 'pointer'}}>Stop</button>
                    <button onClick={this.reset} style={{ margin: '0 3%', height: '30px', width: '75px', fontSize: '1.25rem', letterSpacing: '1.8px', borderRadius: '5px', border: 'none', backgroundColor: '#FFC107', color: 'white', outline: 'none', cursor: 'pointer'}}>Reset</button>
                </div>
                <div style={{ marginTop: '3%'}}>
                    ...
                    <button onClick={() => this.save({user: this.state.user, event: this.state.event, hours: this.state.hours, minutes: this.state.minutes, seconds: this.state.seconds})} style={{ marginTop: '2%', height: '30px', width: '75px', fontSize: '1.25rem', letterSpacing: '1.8px', borderRadius: '5px', border: 'none', backgroundColor: '#007BFF', color: 'white', outline: 'none', cursor: 'pointer'}}>Save</button>
                </div>
